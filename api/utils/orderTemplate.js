...
exports.orderTemplate = ({orderNumber, date, supplier, projectName, orderText}) => {
    const html = htmlToPdfmake(orderText, new JSDOM());
    ...
    return ({
        ...
        content: [
            ...
            '\n\n',
            {
                width: '100%',
                alignment: 'left',
                text: [{text: 'Scope: ', bold: true,}, projectName],
                margin: [0, 0, 0, 0],
                fontSize: 14,
            },
            {},
            ...
            columns: [
                {
                    text: 'SPQ service consult s.r.o., Jizerská 127, 460 15 Liberec 15, CZ\n' +
                        ...
                        'Tel.: +420 603 144 715, IČO: 07664532, DIČ: CZ07664532; Registrace: Krajský soud v Ústí nad Labem, oddíl C, vložka XXXXXXX\n' +
                        ' Bank account CZK: XXXXXXXXXXX/0800; Bank account EUR: XXXXXXXXXXXX/0800',
                    alignment: 'center',
                    fontSize: 8,
                }
            ]
