...
exports.offerTemplate = ({offerNumber, date, partner, company, scope, copyTo, offerText, supplier}) => {
    const html = htmlToPdfmake(offerText, new JSDOM());
    return ({
        ...
        content: [
            ...
            },
            {
                columns: [
                    {
                        text: 'Marek Frajt \n SPQ service consult s.r.o. \n E-mail: info@spq-service.com \nTelephone: +420 603 144 715',
                        bold: true,
                        color: '#333333',
                        alignment: 'left',
                    },
            ...
            '\n\n',
            {
                width: '100%',
                alignment: 'left',
                text: [{text: 'Scope: ', bold: true,}, scope],
                margin: [0, 0, 0, 0],
                fontSize: 14,
            },
            {},
        ...
        footer: {
            columns: [
                { text: 'SPQ service consult s.r.o., Jizerská 127, 460 15 Liberec 15, CZ\n' +
                        ' Mailing address: Hálkova 1126/2, 460 01 Liberec 1,\n' +
                        'Tel.: +420 603 144 715, IČO: 07664532, DIČ: CZ07664532; Registrace: Krajský soud v Ústí nad Labem, oddíl C, vložka 42716\n' +
                        ' Bank account CZK: 5527071369/0800; Bank account EUR: 2019659293/0800',
                    alignment: 'center',
                    fontSize: 8,
                }
            ]
